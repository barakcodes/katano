...
const styles = {
    base: [
        // Base
        "relative isolate inline-flex items-center justify-center gap-x-2 rounded-[0.6rem]  border text-base/6 font-semibold",
    ...
    solid: [
        ...
        "before:absolute before:inset-0 before:-z-10 before:rounded-[calc(0.6rem-1px)] before:bg-[--btn-bg]",
        ...
        "after:absolute after:inset-0 after:-z-10 after:rounded-[calc(0.6rem-1px)]",
        ...
        "dark:after:-inset-px dark:after:rounded-[0.6rem]",
...
) & { children: React.ReactNode } & HeadlessButtonProps;
